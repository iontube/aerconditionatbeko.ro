...
async function main() {
  ...
  const projectName = process.env.CLOUDFLARE_PROJECT_NAME || 'aerconditionatbeko-ro';
...
function generateImagePrompt(keyword, category) {
  const basePrompts = {
    'Aparate Aer Conditionat': 'Ultra-realistic photo of modern air conditioning unit mounted on white wall, clean contemporary room, soft natural daylight, high detail texture, sharp focus, professional product photography, no people, neutral background, realistic proportions',
    'Instalare si Montaj': 'Ultra-realistic photo of air conditioning installation tools and equipment, professional setup, clean workspace, soft studio lighting, high detail texture, sharp focus, professional photography, no people, neutral background',
    'Intretinere si Curatare': 'Ultra-realistic photo of clean air conditioning filter and maintenance equipment, bright modern interior, soft natural daylight, high detail texture, sharp focus, professional photography, no people, neutral background',
    'Eficienta Energetica': 'Ultra-realistic photo of modern energy-efficient air conditioning unit with digital display, contemporary home setting, soft ambient lighting, high detail texture, sharp focus, professional photography, no people, neutral background',
    'Ghiduri si Sfaturi': 'Ultra-realistic photo of modern air conditioning unit in stylish living room, contemporary interior design, soft natural lighting, high detail texture, sharp focus, professional product photography, no people, neutral background'
  };
